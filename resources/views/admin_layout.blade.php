...
<head>
    ...
    <title>Laravel Layout Project</title>
...
<body>
    <div id="header-wrapper" style="background-color: #337ab7;">
        <div id="header" class="container" >
            ...
            <div id="menu">
                <ul>
                    <li class="{{ (request()->segment(1) == '') ? 'current_page_item' : '' }}" ><a href="{{url('/admin/dashboard')}}" accesskey="1" title="">Admin Dashboard</a></li>
                    <li class="{{ (request()->segment(1) == 'notes') ? 'current_page_item' : '' }}"><a href="{{url('/admin/all_notes')}}" accesskey="4" title="">Notes</a></li>
                    <li class="{{ (request()->segment(1) == 'articles') ? 'current_page_item' : '' }}"><a href="{{url('/admin/view_tags')}}" accesskey="2" title="">Tags</a></li>
                    <li class="{{ (request()->segment(1) == 'articles') ? 'current_page_item' : '' }}"><a href="{{url('/admin/view_users')}}" accesskey="2" title="">Users</a></li>
                    @if (Route::has('login'))
                        @auth
